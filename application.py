...
class Application(tkinter.Tk):
    def __init__(self):
        ...
        #Ввод текста
        entry_text=tkinter.Text(width=30,height=1)
        entry_text.place(x=250, y=568)

        send_text=tkinter.Button(text="Отправить",command=lambda:self.send_text(entry_text.get("1.0","end")))
        send_text.place(x=500,y=565)
